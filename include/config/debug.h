...
// Pokémon Debug
#define DEBUG_POKEMON_SPRITE_VISUALIZER ENABLED_ON_RELEASE // Enables a debug menu for Pokémon sprites and icons, accessed by pressing Select in the summary screen.
